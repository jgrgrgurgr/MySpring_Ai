...
class StrokePredictor:
    def __init__(self, base_image_path):
        ...
        base_model = load_model("keras_Model.h5", compile=False)
        ...
        for filename in os.listdir(folder_path):
            if filename.lower().endswith(valid_extensions):
                ...
                if "error" in result:
                    ...
                    print(f"변화 정도(심각성 점수): {result['severity_score']:.4f}")
                    print("-" * 50)
...
def main():
    folder_path = "/Users/harold0812/Desktop/2025 2G/AI project (myspring)/Myspring_AI_Develop/Annotated stroke and non stroke Dataset/Stroke"
    base_image_path = "/Users/harold0812/Desktop/2025 2G/AI project (myspring)/Myspring_AI_Develop/Annotated stroke and non stroke Dataset/Stroke/img_0023.jpg"
